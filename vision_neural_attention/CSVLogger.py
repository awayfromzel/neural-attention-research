        ...
        with open(self.csv_file, mode='a', newline='') as file:
            ...
            if not file_exists:
                ...
                writer.writerow([
                    ...
                    "Training Loss", "Validation Accuracy", "Learning Rate", 
                    "Throughput", "Gradient Norm", "Inference Time (s)", 
                    "Inference Time per Sample (s)", "GPU Memory Allocated (MB)", 
                    "GPU Memory Reserved (MB)"
                ])

    def log(self, current_time, iteration, running_time, training_loss, val_accuracy, 
            learning_rate, throughput, gradient_norm, 
            inference_time, inference_time_per_sample, memory_allocated, memory_reserved):
        # Write the data to the CSV file
        with open(self.csv_file, mode='a', newline='') as file:
            writer = csv.writer(file)
            writer.writerow([
                current_time, iteration, running_time, training_loss, val_accuracy, 
                learning_rate, throughput, gradient_norm, 
